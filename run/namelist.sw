&sw_model
	...
	config_PV_scheme                  = 'APVM_Conservation'	 ! PV interpolate scheme choose from 'order2', 'order2_smooth','APVM', 'APVM_Conservation', 'LUST' or 'CLUST', defalut is 'APVM'
...
/
&mesh
    config_mesh_file = 'x1.2562.grid.nc'
/
