module const_mod
  ...
  real(real_kind_8), parameter :: radius = 6371220d0
  real(real_kind_8), parameter :: g      = 9.80616d0
  real(real_kind_8), parameter :: omega  = 7.292d-5
  real(real_kind_8), parameter :: pi     = 4.0d0 * atan(1.0d0)
  real(real_kind_8), parameter :: pi2    = pi * 2.0d0
