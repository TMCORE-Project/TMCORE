...
contains
  ...
  subroutine history_init()
    ...
    call io_add_var('h0', 'pv',             long_name='Potential vorticity on the vertex',           units='s-1',    dim_names=['nVertices', 'Time     '],       data_type='real(8)')
    call io_add_var('h0', 'vor',            long_name='relative vorticity on the vertex',            units='s-1',    dim_names=['nVertices', 'Time     '],       data_type='real(8)')
  ...
  subroutine history_write_state(state, static)
    ...
    call io_output('h0', 'vor',             state%vertex%vor)
