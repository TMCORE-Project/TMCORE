module diagnostics_tools
    ...
    subroutine compute_vorticity(u,vorticity)
        ...
        ! Scheme3
        !circulation = -t(1,:)*dcEdge(edgesOnVertex(1,:))*u(edgesOnVertex(1,:)) &
        !              -t(2,:)*dcEdge(edgesOnVertex(2,:))*u(edgesOnVertex(2,:)) &
        !              -t(3,:)*dcEdge(edgesOnVertex(3,:))*u(edgesOnVertex(3,:))
